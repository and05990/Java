public class ParcoVeicolo {
    ...
    private final int MAX_NUM_VEICOLI = 1000;
    private int codice;
    ...
    public String[] inventarioVeicoliPosti(int posti){
        ...
        return inventario; //ritorno un vettore con al interno marca e n_posti
    }
    ...
    public String[] inventarioVeicoliMarca(){
        ...
        for(j=0;marca[j] != null;j++)
            inventario[j] = marca[j]+" --> "+veicoli[j];
        return inventario; //ritorna un vettore con il numero di macchine della stessa marca
    }
}
